...
<head>
    <meta charset="utf-8">
    <title>APPLY FOR COURSE | THE APPRENTICE FIRM</title>
...
<div class="contentheaderimagewrapper">
    <div class="contentheaderimageholder"><img src="images/applycourses.jpg" width="100%" height="auto" style="min-height: 400px;"></div>
</div>
...
<div class="otherpagecontentwrapper">
    ...
    <div class="otherpagesecondnavwrapper">
        <div class="otherpagesecondnav">
            <ul id="menu">
                <li><a href="javascript:void(0)" class="active">&nbsp;&nbsp;Apply Course&nbsp;&nbsp;</a></li>
            </ul>
        ...
        <div id="contents">
            ...
            <table>
                <tr>
                    <td>Course Type</td>
                    <td>
                        <select name='states' required onchange="fillSelect(this.value,this.form['cities'])">
